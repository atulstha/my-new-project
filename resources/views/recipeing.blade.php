...
@endforeach  
<!----- -veg---  --> 
<form  class="well form-horizontal" action="{{url('recipe/add/ing')}}" method="POST" enctype="multipart/form-data"  id="contact_form">
{{csrf_field()}}
    @foreach($recipe as $rec)
<input type="hidden" name="id" value= "{{$rec->recipe_id}}"> 
    @endforeach  
     <h4>Vegetable</h4>
