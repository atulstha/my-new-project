                            ...
                            <div class="tab-pane" id="account">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="choice" data-toggle="wizard-checkbox">
                                                <input type="checkbox" name="jobb" value="Not-specified">
                                                <div class="icon">
                                                    <i class="fa fa-terminal"></i>
                                                </div>
                                                <h6>Others</h6>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">
                                        <div class="col-sm-4">
                                            <div class="choice" data-toggle="wizard-checkbox">
                                                <input type="radio" name="cook-level" value="Home">
                                                <div class="icon">
                                                    <i class="fa fa-pencil"></i>
                                                </div>
                                                <h6>HOME COOK</h6>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="choice" data-toggle="wizard-checkbox">
                                                <input type="radio" name="jobb" value="Intermediate">
                                                <div class="icon">
                                                    <i class="fa fa-terminal"></i>
                                                </div>
                                                <h6>Intermediate</h6>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="choice" data-toggle="wizard-checkbox">
                                                <input type="radio" name="jobb" value="Proffesional">
                                                <div class="icon">
                                                    <i class="fa fa-terminal"></i>
                                                </div>
                                                <h6>Cooking as a profession</h6>
                                            </div>
